...
class ServerResponse{
    ...
    public static let ANALYSIS_SUCCESS: Int = 700
    public static let ANALYSIS_FAILURE: Int = 701
    ...
    public static let WATER_SUCCESS: Int = 1000
    public static let WATER_FAILURE: Int = 1001
